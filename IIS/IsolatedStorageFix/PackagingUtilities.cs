// Modified from https://referencesource.microsoft.com/#WindowsBase/Shared/MS/Internal/IO/Packaging/PackagingUtilities.cs
// This is to make the repro of the issue easier.  PackagingUtilities is internal in the framework.
...
namespace IsolatedStorageFix
{
    internal static class PackagingUtilities
    {
        ...
        /// the underlying file is deleted when the stream is closed.
        /// </summary>
        internal class ReliableIsolatedStorageFileFolder : IDisposable
        {
            //------------------------------------------------------
            //
            //  Internal Properties
